...
const updated = swSrc.replace(/const CACHE = '[^']*'/, `const CACHE = '${appName}-shell-v${version}'`)

writeFileSync(swPath, updated)
console.log(`bump-sw-cache: dist/sw.js cache name set to ${appName}-shell-v${version}`)
